...
const ScanningScreen: React.FC<Props> = ({ onComplete }) => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-between py-12 px-8 relative overflow-hidden">
      ...
      <div className="text-center z-10 w-full mt-4 flex flex-col items-center">

        {/* Title above car */}
        <h2 className="text-3xl font-heading font-bold text-brand-primary uppercase tracking-tight mb-4">
          Diagnostic en cours...
        </h2>

        {/* Car Image + Scan Effect */}
        <div className="relative mb-4 w-60 md:w-80 h-24 flex items-center justify-center overflow-hidden rounded-2xl">
          <motion.div
      ...
      <motion.div
        ...
        className="w-full max-w-4xl aspect-[16/7] bg-white rounded-[2.5rem] relative overflow-hidden flex shadow-xl border border-slate-200 mt-4 mb-12"
      >
        <div className="flex-1 p-8 md:p-10 flex flex-col justify-center relative z-10">
          ...
          <h3 className="text-3xl md:text-4xl font-heading font-black text-slate-800 mb-4 leading-tight tracking-tight">
            Pneumatiques<br />
            <span className="text-brand-accent">-20% chez EuroMaster</span>
          </h3>
          <p className="text-slate-500 text-sm max-w-sm mb-8">
            Profitez de <strong className="text-slate-700">-20% sur la pose et l'équilibrage</strong> dans tous les centres EuroMaster partenaires. Qualité garantie, prise en charge immédiate.
          </p>
      ...
      {/* ── Element 3: Progress Bar + System Checks ── */}
